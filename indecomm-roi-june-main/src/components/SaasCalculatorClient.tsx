...
import { ClientPlatformCostInputs } from "./saas/ClientPlatformCostInputs";
        ...
        <div className="mx-auto max-w-7xl px-6 py-6 space-y-5">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
            <div className="lg:col-span-2 space-y-4">
              <SaasVolumeInputs />
              <SaasRolesTable />
              {/* Client's legacy platform cost — rendered BEFORE the internal
                  cost section so the "Total Annual Cost Before / After" cards
                  at the bottom of SaasInternalCostInputs sit just above the
                  Indecomm Platform Pricing section (only renders for models
                  that have it, e.g. NFCU). */}
              <ClientPlatformCostInputs />
