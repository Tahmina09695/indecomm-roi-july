                    ...
                    {model.displayPreference === "savings-first" ? (
                      <tr>
                        <td>
                          ...
                          <div style={{ fontSize: 34, fontWeight: 800, lineHeight: 1.0, marginTop: 2 }}>{fmtCurrency(r.year1.savings, { compact: true })}</div>
                        ...
                        <td style={{ borderLeft: `2px solid ${accent}55`, paddingLeft: 16 }}>
                          ...
                          <div style={{ fontSize: 34, fontWeight: 800, lineHeight: 1.0, marginTop: 2, color: accent }}>{fmtCurrency(r.year2.savings, { compact: true })}</div>
                      ...
                      <tr>
                        <td>
                          ...
                          <div style={{ fontSize: 10, color: "#002060AA" }}>Savings: <strong>{fmtCurrency(r.year1.savings, { compact: true })}</strong> ({fmtPercent(r.year1.savingsPct, 0)})</div>
                        </td>
                        <td style={{ borderLeft: `2px solid ${accent}55`, paddingLeft: 16 }}>
                          ...
                          <div style={{ fontSize: 10, color: "#002060AA" }}>Savings: <strong>{fmtCurrency(r.year2.savings, { compact: true })}</strong> ({fmtPercent(r.year2.savingsPct, 0)})</div>
                        </td>
                        <td style={{ textAlign: "right", borderLeft: `2px solid ${accent}55`, paddingLeft: 16 }}>
                          <div style={{ fontSize: 10, fontWeight: 800, letterSpacing: 1.2, textTransform: "uppercase", color: "#002060AA" }}>{fteLabel}</div>
                          <div style={{ fontSize: 32, fontWeight: 800, lineHeight: 1.0, marginTop: 2 }}>{r.internal.fteSaved.toFixed(1)}</div>
